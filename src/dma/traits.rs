...
dma_map!(
    ...
    (Stream1<DMA1>, 4, Rx<pac::USART3>, PeripheralToMemory),     //USART3_RX
    (Stream3<DMA1>, 4, Tx<pac::USART3>, MemoryToPeripheral),     //USART3_TX
    (Stream4<DMA1>, 7, Tx<pac::USART3>, MemoryToPeripheral),     //USART3_TX:DMA_CHANNEL_7
);
